...
* `ENABLE_PROP_NEGATIVE_BINOMIAL` (Default: `true`)
* `PROP_NEG_BINOMIAL_STATS` (Default: `points,assists,rebounds,three_pointers,steals,blocks,turnovers`)
* `PROP_NEG_BINOMIAL_VARIANCE_MULTIPLIER` (Default: `1.35`; higher values create fatter tails)
* `PROP_CONFIDENCE_FULL_BOOKS` (Default: `3`; sharp-book count needed for full Kelly confidence)
* `PROP_UNCERTAINTY_Z` (Default: `0.35`; larger values make prop sizing more conservative)
* `PROP_UNCERTAINTY_EFFECTIVE_SAMPLES` (Default: `24`; controls the Kelly probability haircut)
...
* `ARBITRAGE_MIN_PROFIT` (Default: `0.005`)
* `ARBITRAGE_MAX_ALERTS` (Default: `10`)
...
* `ENABLE_ARBITRAGE_SCAN` (Default: `true`)
