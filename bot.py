...
def calculate_edge_metrics(sharp_odds_target, sharp_odds_opponent, soft_odds_target):
    # De-vig the sharp market to get the "True" probability
    ...
    # Quarter Kelly Staking (Conservative growth)
    ...
    for book in soft_books:
        ...
        for market in book.get('markets', []):
            ...
            for soft_outcome in market['outcomes']:
                ...
                # 🚀 Range Filter: -500 to +250
                if soft_odds > 250 or soft_odds < -500:
                    continue
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        params = {
            ...
            "markets": "h2h,player_points,player_rebounds,player_assists,player_threes,player_double_double", 
            "oddsFormat": "american",
            "bookmakers": "pinnacle,draftkings,fanduel,betmgm,espnbet,bet365,caesars,betrivers,bovada,novig" 
        }
        ...
        if all_profitable_plays:
            ...
            for play in all_profitable_plays:
                if play['id'] not in sent_history:
                    ...
                    # 🚀 Save odds & timestamp for CLV tracking
                    sent_history[play['id']] = {
                        "odds": play['odds'],
                        "fair": play['fair_odds'],
