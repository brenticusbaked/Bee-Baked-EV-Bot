...
OPTIONAL_VARS = [
    ...
    EnvVar(
        ...
        "execution desk edge lane (falls back to bet alerts)",
        optional=True,
        expected_prefix="https://discord.com/api/webhooks/",
    ),
    EnvVar(
        "DISCORD_NEAR_MISS_WEBHOOK_URL",
        "+EV near miss digest lane (falls back to status)",
        optional=True,
        expected_prefix="https://discord.com/api/webhooks/",
    ),
    EnvVar(
        "DISCORD_HOME_RUNS_WEBHOOK_URL",
        "MLB home run model lane (falls back to MLB bets)",
        optional=True,
        expected_prefix="https://discord.com/api/webhooks/",
    ),
