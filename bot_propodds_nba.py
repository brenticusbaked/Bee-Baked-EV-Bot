...
def get_sgo_edges():
    ...
    # Expanded list of soft sources including KY legal, Offshore, and DFS
    soft_list = [
                        ...
                        if side in soft:
                            ...
                            if ev > 0.02:
                                ...
                                if not is_already_logged(matchup, market, selection):
                                    is_em = ev >= 0.06
                                    log_bet_to_db(matchup, market, selection, to_american(soft[side]['price']), ev, "1.00", "PROPS")
...
if __name__ == "__main__":
    for p in get_sgo_edges():
        requests.post(DISCORD_WEBHOOK_URL, json={"embeds": [{"description": p['msg'], "color": 15158332}]})